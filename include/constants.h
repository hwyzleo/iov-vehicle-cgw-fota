...
// SOME/IP service IDs
constexpr uint16_t DEFAULT_DIAG_SERVICE_ID = 0x0001;
...
// Method IDs for SOME/IP
constexpr uint16_t METHOD_COLLECT_VEHICLE_INVENTORY = 0x0001;
constexpr uint16_t METHOD_GET_ECU_VERSION = 0x0002;
constexpr uint16_t METHOD_GET_REGISTRY_VERSION = 0x0003;
constexpr uint16_t METHOD_REPORT_SOFTWARE_INVENTORY = 0x0004;
